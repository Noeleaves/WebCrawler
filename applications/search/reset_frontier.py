...
from datamodel.search.Yimingc9Vaibhap1Tzucl2Llin20_datamodel import Yimingc9Vaibhap1Tzucl2Llin20ProjectionLink
...
@Deleter(Yimingc9Vaibhap1Tzucl2Llin20ProjectionLink)
@Getter(Yimingc9Vaibhap1Tzucl2Llin20ProjectionLink)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(Yimingc9Vaibhap1Tzucl2Llin20ProjectionLink)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(Yimingc9Vaibhap1Tzucl2Llin20ProjectionLink, l)
